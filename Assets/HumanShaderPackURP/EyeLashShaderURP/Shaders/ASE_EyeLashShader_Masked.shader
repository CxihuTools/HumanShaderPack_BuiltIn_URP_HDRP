...
Shader "ASE_EyeLashShader_Masked_Transparent"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_MaskedTextureRGB("MaskedTexture(RGB)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MaskedTextureRGB = IN.ase_texcoord7.xy * _MaskedTextureRGB_ST.xy + _MaskedTextureRGB_ST.zw;
				float4 tex2DNode6 = tex2D( _MaskedTextureRGB, uv_MaskedTextureRGB );
				float temp_output_9_0 = saturate( ( ( tex2DNode6.r + tex2DNode6.g + tex2DNode6.b ) / 3.0 ) );
				float height107_g1 = temp_output_9_0;
				float scale107_g1 = _BumpPower;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_MaskedTextureRGB = IN.ase_texcoord2.xy * _MaskedTextureRGB_ST.xy + _MaskedTextureRGB_ST.zw;
				float4 tex2DNode6 = tex2D( _MaskedTextureRGB, uv_MaskedTextureRGB );
				float temp_output_9_0 = saturate( ( ( tex2DNode6.r + tex2DNode6.g + tex2DNode6.b ) / 3.0 ) );
...
/*ASEBEGIN
Version=18909
806;411.3333;1492;954;668;645;1;True;False
Node;AmplifyShaderEditor.SamplerNode;6;-327,-224;Inherit;True;Property;_MaskedTextureRGB;MaskedTexture(RGB);0;0;Create;True;0;0;0;False;0;False;-1;None;12cfe191f29b5744d9b5b1208a150be4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;7;-42,-196;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;8;78,-194;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;387,126;Inherit;False;Property;_Occlusion;Occlusion;6;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;259,-456;Inherit;False;Property;_BaseColour;BaseColour;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;190,-125;Inherit;False;Property;_Metal;Metal;4;0;Create;True;0;0;0;False;0;False;0;0.411;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;9;190,-194;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;11;182,-288;Inherit;False;Normal From Height;-1;;1;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;10;189,15;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-310,-297;Inherit;False;Property;_BumpPower;BumpPower;3;0;Create;True;0;0;0;False;0;False;0;0.032;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;187,-55;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0.4;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D8BB51B99BD1E7B98FA50B826787C56E3D2CD3CC