...
Shader "Skin Shaders/HDRP/HDRP_SSS6"
{
	Properties
	{
		...
		[ASEEnd]_BaseToneGlow("BaseToneGlow", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_SSS_TextureWeightA = packedInput.ase_texcoord5.xy * _SSS_TextureWeightA_ST.xy + _SSS_TextureWeightA_ST.zw;
				...
				float dotResult193 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_1 = (dotResult193).xxx;
				float3 objToWorldDir30 = mul( GetObjectToWorldMatrix(), float4( packedInput.ase_texcoord6.xyz, 0 ) ).xyz;
				...
				float4 lerpResult145 = lerp( ( temp_output_113_0 + ( float4( ( clampResult82 * _DirectionalLightDatas[0].color.rgb ) , 0.0 ) * lerpResult102 ) ) , _Mask1_Rchannel_ColorAmountA , temp_output_154_0);
				...
				float dotResult72 = dot( -V , -_DirectionalLightDatas[0].forward );
				...
				float2 temp_cast_3 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_4 = (_MicroDetail_Offset).xx;
				float2 texCoord142 = packedInput.ase_texcoord5.xy * temp_cast_3 + temp_cast_4;
				...
				float4 lerpResult254 = lerp( float4( 0,0,0,0 ) , clampResult246 , _BaseToneGlow);
				float4 lerpResult241 = lerp( float4( 0,0,0,0 ) , clampResult110 , _SSS_ToEmissive);
				float4 FinalEmissive256 = lerpResult241;
				
				float2 uv_MetalGloss = packedInput.ase_texcoord5.xy * _MetalGloss_ST.xy + _MetalGloss_ST.zw;
				float clampResult170 = clamp( ( ( tex2D( _MetalGloss, uv_MetalGloss ).a + _SmoothnessDeviate ) + ( ( temp_output_154_0 * _GlossAdjust_Mask1Rchannel ) + ( temp_output_155_0 * _GlossAdjust_Mask1Gchannel ) + ( temp_output_156_0 * _GlossAdjust_Mask1Bchannel ) + ( temp_output_157_0 * _GlossAdjust_Mask2Rchannel ) + ( temp_output_158_0 * _GlossAdjust_Mask2Gchannel ) + ( temp_output_159_0 * _GlossAdjust_Mask2Bchannel ) ) ) , 0.0 , 1.0 );
				float Gloss237 = clampResult170;
				
				surfaceDescription.Albedo = clampResult246.rgb;
				surfaceDescription.Normal = normalizeResult188;
				...
				surfaceDescription.Emission = ( lerpResult254 + FinalEmissive256 ).rgb;
				surfaceDescription.Smoothness = Gloss237;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float dotResult24 = dot( -_DirectionalLightDatas[0].forward , packedInput.ase_normal );
				float clampResult82 = clamp( dotResult24 , 0.0 , 1.0 );
				float2 uv_SSS_TextureWeightA = packedInput.ase_texcoord.xy * _SSS_TextureWeightA_ST.xy + _SSS_TextureWeightA_ST.zw;
				float4 tex2DNode114 = tex2D( _SSS_TextureWeightA, uv_SSS_TextureWeightA );
				float lerpResult133 = lerp( 0.0 , tex2DNode114.a , _SSS_WeightAmount);
				float4 temp_output_115_0 = ( tex2DNode114 * lerpResult133 );
				float dotResult193 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_1 = (dotResult193).xxx;
				float3 objToWorldDir30 = mul( GetObjectToWorldMatrix(), float4( packedInput.ase_texcoord1.xyz, 0 ) ).xyz;
				float3 normalizeResult32 = normalize( objToWorldDir30 );
				float dotResult37 = dot( temp_cast_1 , normalizeResult32 );
				float clampResult131 = clamp( ( ( dotResult37 + _Light_Bias ) * _Light_Scale ) , 0.0 , 1.0 );
				float4 lerpResult102 = lerp( ( _MainLightTint * clampResult82 * temp_output_113_0 ) , ( _ScatterColor * abs( ( temp_output_115_0 * clampResult131 ) ) ) , _LightScatter);
				...
				float2 temp_cast_3 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_4 = (_MicroDetail_Offset).xx;
				float2 texCoord142 = packedInput.ase_texcoord.xy * temp_cast_3 + temp_cast_4;
				float3 unpack137 = UnpackNormalScale( tex2D( _MicroDetailNormalMap, texCoord142 ), _MicroDetail_Power );
				unpack137.z = lerp( 1, unpack137.z, saturate(_MicroDetail_Power) );
				...
				float2 uv_MetalGloss = packedInput.ase_texcoord.xy * _MetalGloss_ST.xy + _MetalGloss_ST.zw;
				float clampResult170 = clamp( ( ( tex2D( _MetalGloss, uv_MetalGloss ).a + _SmoothnessDeviate ) + ( ( temp_output_154_0 * _GlossAdjust_Mask1Rchannel ) + ( temp_output_155_0 * _GlossAdjust_Mask1Gchannel ) + ( temp_output_156_0 * _GlossAdjust_Mask1Bchannel ) + ( temp_output_157_0 * _GlossAdjust_Mask2Rchannel ) + ( temp_output_158_0 * _GlossAdjust_Mask2Gchannel ) + ( temp_output_159_0 * _GlossAdjust_Mask2Bchannel ) ) ) , 0.0 , 1.0 );
				float Gloss237 = clampResult170;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord142 = packedInput.ase_texcoord3.xy * temp_cast_0 + temp_cast_1;
				float3 unpack137 = UnpackNormalScale( tex2D( _MicroDetailNormalMap, texCoord142 ), _MicroDetail_Power );
				unpack137.z = lerp( 1, unpack137.z, saturate(_MicroDetail_Power) );
				...
				float2 uv_MetalGloss = packedInput.ase_texcoord3.xy * _MetalGloss_ST.xy + _MetalGloss_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float dotResult24 = dot( -_DirectionalLightDatas[0].forward , packedInput.ase_normal );
				float clampResult82 = clamp( dotResult24 , 0.0 , 1.0 );
				float2 uv_SSS_TextureWeightA = packedInput.ase_texcoord7.xy * _SSS_TextureWeightA_ST.xy + _SSS_TextureWeightA_ST.zw;
				float4 tex2DNode114 = tex2D( _SSS_TextureWeightA, uv_SSS_TextureWeightA );
				float lerpResult133 = lerp( 0.0 , tex2DNode114.a , _SSS_WeightAmount);
				float4 temp_output_115_0 = ( tex2DNode114 * lerpResult133 );
				float dotResult193 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_1 = (dotResult193).xxx;
				float3 objToWorldDir30 = mul( GetObjectToWorldMatrix(), float4( packedInput.ase_texcoord8.xyz, 0 ) ).xyz;
				float3 normalizeResult32 = normalize( objToWorldDir30 );
				float dotResult37 = dot( temp_cast_1 , normalizeResult32 );
				float clampResult131 = clamp( ( ( dotResult37 + _Light_Bias ) * _Light_Scale ) , 0.0 , 1.0 );
				float4 lerpResult102 = lerp( ( _MainLightTint * clampResult82 * temp_output_113_0 ) , ( _ScatterColor * abs( ( temp_output_115_0 * clampResult131 ) ) ) , _LightScatter);
				...
				float2 temp_cast_3 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_4 = (_MicroDetail_Offset).xx;
				float2 texCoord142 = packedInput.ase_texcoord7.xy * temp_cast_3 + temp_cast_4;
				float3 unpack137 = UnpackNormalScale( tex2D( _MicroDetailNormalMap, texCoord142 ), _MicroDetail_Power );
				unpack137.z = lerp( 1, unpack137.z, saturate(_MicroDetail_Power) );
				...
				float2 uv_MetalGloss = packedInput.ase_texcoord7.xy * _MetalGloss_ST.xy + _MetalGloss_ST.zw;
				float clampResult170 = clamp( ( ( tex2D( _MetalGloss, uv_MetalGloss ).a + _SmoothnessDeviate ) + ( ( temp_output_154_0 * _GlossAdjust_Mask1Rchannel ) + ( temp_output_155_0 * _GlossAdjust_Mask1Gchannel ) + ( temp_output_156_0 * _GlossAdjust_Mask1Bchannel ) + ( temp_output_157_0 * _GlossAdjust_Mask2Rchannel ) + ( temp_output_158_0 * _GlossAdjust_Mask2Gchannel ) + ( temp_output_159_0 * _GlossAdjust_Mask2Bchannel ) ) ) , 0.0 , 1.0 );
				float Gloss237 = clampResult170;
...
/*ASEBEGIN
Version=18801
1920;54;1920;975;-369.2932;1256.499;3.695192;True;False
Node;AmplifyShaderEditor.CommentaryNode;56;-1832.857,19.23205;Inherit;False;1435.461;680.1272;ScatterLight;14;29;30;32;35;40;39;37;44;114;117;133;115;193;272;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;114;-1087.933,336.5719;Inherit;True;Property;_SSS_TextureWeightA;SSS_Texture-Weight(A);6;0;Create;True;0;0;0;False;0;False;-1;None;60d1bb1afb148d9409b39ccf586ba390;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;39;-1538.345,472.2159;Float;False;Property;_Light_Bias;Light_Bias;10;0;Create;True;0;0;0;False;0;False;0;0.291;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;117;-1115.745,546.0661;Float;False;Property;_SSS_WeightAmount;SSS_WeightAmount;7;0;Create;True;0;0;0;False;0;False;0;0.774;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1545.164,584.3593;Float;False;Property;_Light_Scale;Light_Scale;11;0;Create;True;0;0;0;False;0;False;0;3.59;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;57;-1537.432,-617.6573;Inherit;False;915.4287;532.0931;MainLight;7;23;42;24;43;61;82;238;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-212.5699,165.7983;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;51;-1471.425,-841.6143;Float;False;Property;_Albedo_Tint;Albedo_Tint;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6784888,0.7420009,0.745283,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;42;-1142.132,-567.6573;Float;False;Property;_MainLightTint;MainLightTint;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.9150943,0.84684,0.8158152,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;44;-840.3965,42.26363;Float;False;Property;_ScatterColor;ScatterColor;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4245282,0.1964568,0.1902367,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;211.0021,254.6402;Float;False;Property;_LightScatter;LightScatter;12;0;Create;True;0;0;0;False;0;False;0;0.744;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-648.3475,-450.9005;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;201.8478,-212.6943;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;148;2471.771,-1690.372;Float;False;Property;_Mask1_Rchannel_ColorAmountA;Mask1_Rchannel_Color-Amount(A);21;0;Create;True;0;0;0;False;0;False;0.7735849,0.2006942,0.3233189,0.7843137;0.3823529,0.1658736,0.2122101,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;143;1800.598,-1609.35;Inherit;True;Property;_MakeUpMask1_RGB;MakeUpMask1_RGB;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;149;2508.771,-1515.372;Float;False;Property;_Mask1_Gchannel_ColorAmountA;Mask1_Gchannel_Color-Amount(A);22;0;Create;True;0;0;0;False;0;False;0.2,0.772549,0.4917381,0.7843137;0.09861585,0.5588235,0.3331113,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;150;2533.771,-1343.372;Float;False;Property;_Mask1_Bchannel_ColorAmountA;Mask1_Bchannel_Color-Amount(A);23;0;Create;True;0;0;0;False;0;False;0.2,0.406334,0.772549,0.7843137;0.1999999,0.406334,0.772549,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;151;2480.521,-1103.547;Float;False;Property;_Mask2_Rchannel_ColorAmountA;Mask2_Rchannel_Color-Amount(A);24;0;Create;True;0;0;0;False;0;False;0.2,0.772549,0.7071339,0.7843137;0.1999999,0.772549,0.7071339,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;87;345.288,969.9673;Float;False;Property;_BackScatterPower;BackScatterPower;13;0;Create;True;0;0;0;False;0;False;0;1.62;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;152;2517.521,-928.5472;Float;False;Property;_Mask2_Gchannel_ColorAmountA;Mask2_Gchannel_Color-Amount(A);25;0;Create;True;0;0;0;False;0;False;0.772549,0.2,0.6776864,0.7843137;0.772549,0.1999999,0.6776864,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;140;1278.675,919.4932;Float;False;Property;_MicroDetail_Offset;MicroDetail_Offset;16;0;Create;True;0;0;0;False;0;False;0;0.422;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;153;2542.521,-756.5474;Float;False;Property;_Mask2_Bchannel_ColorAmountA;Mask2_Bchannel_Color-Amount(A);26;0;Create;True;0;0;0;False;0;False;0.772549,0.7037676,0.2,0.7843137;0.772549,0.7037676,0.1999999,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;139;1264.742,800.3571;Float;False;Property;_MicroDetail_Tiling;MicroDetail_Tiling;15;0;Create;True;0;0;0;False;0;False;1;5.65;1;12;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;175;3097.648,179.0922;Float;False;Property;_GlossAdjust_Mask2Bchannel;GlossAdjust_Mask2-Bchannel;32;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;1268.047,1031.532;Float;False;Property;_MicroDetail_Power;MicroDetail_Power;17;0;Create;True;0;0;0;False;0;False;1;0.451;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;172;3112.004,-342.6861;Float;False;Property;_GlossAdjust_Mask1Gchannel;GlossAdjust_Mask1-Gchannel;28;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;3099.972,-253.1673;Float;False;Property;_GlossAdjust_Mask1Bchannel;GlossAdjust_Mask1-Bchannel;29;0;Create;True;0;0;0;False;0;False;-1;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;171;3121.295,-432.9468;Float;False;Property;_GlossAdjust_Mask1Rchannel;GlossAdjust_Mask1-Rchannel;27;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;173;3099.442,-55.58076;Float;False;Property;_GlossAdjust_Mask2Rchannel;GlossAdjust_Mask2-Rchannel;30;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;174;3100.015,67.42487;Float;False;Property;_GlossAdjust_Mask2Gchannel;GlossAdjust_Mask2-Gchannel;31;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;1566.091,-49.84906;Float;False;Property;_SmoothnessDeviate;SmoothnessDeviate;5;0;Create;True;0;0;0;False;0;False;0;0.16;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;111;1912.566,370.4979;Inherit;True;Property;_NormalMap;NormalMap;3;0;Create;True;0;0;0;False;0;False;-1;None;203173d0b9b1dae4f94c39ce54c4f7d6;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;243;2434.838,381.0009;Float;False;Property;_SSS_ToEmissive;SSS_ToEmissive;8;0;Create;True;0;0;0;False;0;False;0.1;1.87;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;118;1547.486,-258.6144;Inherit;True;Property;_MetalGloss;Metal-Gloss;4;0;Create;True;0;0;0;False;0;False;-1;None;71f90091d15d707468a6dbc256f509c2;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;241;2794.825,327.2506;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;185;3522.607,987.2743;Float;False;Property;_FinalNormalMapPower;FinalNormalMapPower;33;0;Create;True;0;0;0;False;0;False;1;1.03;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;255;5461.923,-266.4575;Inherit;False;Property;_BaseToneGlow;BaseToneGlow;34;0;Create;True;0;0;0;False;0;False;0;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;256;3035.653,320.8309;Inherit;False;FinalEmissive;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;254;5962.923,-459.4575;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;257;5941.809,-50.71069;Inherit;False;256;FinalEmissive;1;0;OBJECT;;False;1;COLOR;0
...
WireConnection;272;0;133;0
WireConnection;258;0;254;0
WireConnection;258;1;257;0
WireConnection;259;0;246;0
WireConnection;259;1;188;0
WireConnection;259;6;258;0
WireConnection;259;7;237;0
ASEEND*/
//CHKSM=B38F53613C2160AB09762CE03545BF3EA62D4300