...
Shader "Skin Shaders/HDRP/HDRP_SSS6DP"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_Albedo_Tint("Albedo_Tint", Color) = (1,1,1,0)
		...
		[ASEDiffusionProfile(_DiffusionProfile)]_DiffusionProfile_asset("DiffusionProfile", Vector) = ( -140543700173518390000000000000000, 0.000000000000000000000000020030988757709214, 0.000000063132063132798066, -0.0000000000000000044045647082774613 )
		[HideInInspector]_DiffusionProfile("DiffusionProfile", Float) = 2.7317202091217041
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult102 = lerp( temp_output_113_0 , ( _ScatterColor * abs( temp_output_115_0 ) ) , _LightScatter);
				...
				float4 lerpResult145 = lerp( ( temp_output_113_0 + lerpResult102 ) , _Mask1_Rchannel_ColorAmountA , temp_output_154_0);
				...
				float4 clampResult110 = clamp( ( lerpResult102 + temp_output_115_0 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float2 texCoord142 = packedInput.ase_texcoord5.xy * temp_cast_1 + temp_cast_2;
				...
				float SSSThick272 = lerpResult133;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = SSSThick272;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_1 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_2 = (_MicroDetail_Offset).xx;
				float2 texCoord142 = packedInput.ase_texcoord.xy * temp_cast_1 + temp_cast_2;
				float3 unpack137 = UnpackNormalScale( tex2D( _MicroDetailNormalMap, texCoord142 ), _MicroDetail_Power );
				unpack137.z = lerp( 1, unpack137.z, saturate(_MicroDetail_Power) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_1 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_2 = (_MicroDetail_Offset).xx;
				float2 texCoord142 = packedInput.ase_texcoord7.xy * temp_cast_1 + temp_cast_2;
				float3 unpack137 = UnpackNormalScale( tex2D( _MicroDetailNormalMap, texCoord142 ), _MicroDetail_Power );
				unpack137.z = lerp( 1, unpack137.z, saturate(_MicroDetail_Power) );
...
/*ASEBEGIN
Version=18801
1920;54;1920;975;-5113.962;195.7589;1;True;False
...
Node;AmplifyShaderEditor.DiffusionProfileNode;270;6007.809,235.2893;Float;False;Property;_DiffusionProfile;DiffusionProfile;35;0;Create;True;0;0;0;False;0;False;26bdddf49760c61438938733f07fa2a2;26bdddf49760c61438938733f07fa2a2;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-203.2351,126.5922;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;273;6040.492,152.8275;Inherit;False;272;SSSThick;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;259;16;273;0
WireConnection;259;21;270;0
ASEEND*/
//CHKSM=4AF1DDC783F5AFB58FD5FD14B3599AEF4AB85E47