...
Shader "Skin Shaders/HDRP/HDRP_SSS2"
{
	/*CustomNodeUI:HDPBR*/
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float dotResult119 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				...
				surfaceDescription.Albedo = _Albedo_Color.rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.Emission = clampResult116.rgb;
        ...
        Pass
        {
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float dotResult119 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_1 = (dotResult119).xxx;
				float3 objToWorldDir30 = mul( GetObjectToWorldMatrix(), float4( packedInput.ase_texcoord.xyz, 0 ) ).xyz;
				float3 normalizeResult32 = normalize( objToWorldDir30 );
				float dotResult37 = dot( temp_cast_1 , normalizeResult32 );
				float clampResult112 = clamp( ( ( dotResult37 + _Light_Bias ) * _Light_Scale ) , 0.0 , 1.0 );
				float4 lerpResult102 = lerp( temp_output_43_0 , ( _ScatterColor * clampResult112 ) , _LightScatter);
...
/*ASEBEGIN
Version=17700
1920;0;1920;1029;3038.898;911.7161;2.114341;True;False
Node;AmplifyShaderEditor.CommentaryNode;56;-1832.857,19.23205;Inherit;False;1435.461;680.1272;ScatterLight;11;29;30;32;35;40;39;37;44;38;33;119;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;118;-1816.184,-118.8298;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;57;-1537.432,-617.6573;Inherit;False;915.4287;532.0931;MainLight;6;22;23;24;43;82;51;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.DotProductOpNode;119;-1231.721,92.84565;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;22;-1485.335,-402.1946;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.NormalVertexDataNode;23;-1446.278,-249.436;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;112;-404.1412,277.1945;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;58;-293.5292,-316.7261;Inherit;False;722.2638;725.0239;FuzzMix;1;45;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-680.5528,-435.8714;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;102;623.5731,137.3984;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;109;1294.061,114.0206;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;113;1500.466,-160.2293;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;116;1797.166,-146.4648;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
WireConnection;120;5;59;0
ASEEND*/
//CHKSM=38F8E40389486D2CDD1FF078FAC3F60C87C0DC48