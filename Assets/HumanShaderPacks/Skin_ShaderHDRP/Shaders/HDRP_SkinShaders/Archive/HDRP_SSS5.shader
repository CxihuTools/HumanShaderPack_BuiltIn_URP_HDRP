...
Shader "Skin Shaders/HDRP/HDRP_SSS5"
{
	/*CustomNodeUI:HDPBR*/
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert ( AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6 = inputMesh.positionOS;
						...
						)
			{
				...
				float dotResult145 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_1 = (dotResult145).xxx;
				...
				float3 tex2DNode111 = UnpackNormalmapRGorAG( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				float2 temp_cast_3 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_4 = (_MicroDetail_Offset).xx;
				float2 uv0142 = packedInput.ase_texcoord5.xy * temp_cast_3 + temp_cast_4;
				...
				float3 lerpResult135 = lerp( tex2DNode111 , BlendNormal( tex2DNode111 , UnpackNormalmapRGorAG( tex2D( _MicroDetailNormalMap, uv0142 ), _MicroDetail_Power ) ) , tex2D( _MicroDetail_WeightMapGreyscaleR, uv_MicroDetail_WeightMapGreyscaleR ).r);
				...
				surfaceDescription.Albedo = ( temp_output_113_0 + ( float4( ( clampResult82 * _DirectionalLightDatas[0].color.rgb ) , 0.0 ) * lerpResult102 ) ).rgb;
				surfaceDescription.Normal = lerpResult135;
				surfaceDescription.Emission = clampResult110.rgb;
				surfaceDescription.Specular = 0;
				surfaceDescription.Metallic = tex2DNode118.r;
				surfaceDescription.Smoothness = ( tex2DNode118.a + _SmoothnessDeviate );
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert ( AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_normal = inputMesh.normalOS;
				outputPackedVaryingsMeshToPS.ase_texcoord1 = inputMesh.positionOS;
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_3 = (_MicroDetail_Tiling).xx;
				float2 temp_cast_4 = (_MicroDetail_Offset).xx;
				float2 uv0142 = packedInput.ase_texcoord.xy * temp_cast_3 + temp_cast_4;
...
/*ASEBEGIN
Version=17700
1920;0;1920;1029;2273.256;645.6508;1.652588;True;False
Node;AmplifyShaderEditor.CommentaryNode;56;-1832.857,19.23205;Inherit;False;1435.461;680.1272;ScatterLight;12;29;30;32;35;40;39;37;44;114;117;133;145;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;144;-1832.863,-131.4891;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DotProductOpNode;145;-1427.903,66.60407;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;114;-1099.03,344.3062;Inherit;True;Property;_SSS_TextureWeightA;SSS_Texture-Weight(A);7;0;Create;True;0;0;False;0;-1;None;e6d86e9a4ed19194c9d490918b589aec;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;38;-818.4666,755.3414;Inherit;False;ConstantBiasScale;-1;;8;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;112;-1507.575,-1047.724;Inherit;True;Property;_Albedo;Albedo;3;0;Create;True;0;0;False;0;-1;None;c0dbd8f605bce35418db6c35b9dc503d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;58;-293.5292,-316.7261;Inherit;False;722.2638;725.0239;FuzzMix;4;45;128;130;33;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;-528.6672,247.3148;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-223.9199,184.3272;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.AbsOpNode;130;201.4902,208.0211;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;137;1967.302,799.6944;Inherit;True;Property;_MicroDetailNormalMap;MicroDetail(NormalMap);14;0;Create;True;0;0;False;0;-1;None;287acedd1e86ed140951c44576dc5b5c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;264.8788,-424.4785;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;111;1130.728,-389.6214;Inherit;True;Property;_NormalMap;NormalMap;4;0;Create;True;0;0;False;0;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;118;1547.486,-258.6144;Inherit;True;Property;_MetalGloss;Metal-Gloss;5;0;Create;True;0;0;False;0;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;146;4;118;0
WireConnection;146;5;119;0
ASEEND*/
//CHKSM=F42BC7E7B7EC80E0D0544B6498ACCF58B39961A2