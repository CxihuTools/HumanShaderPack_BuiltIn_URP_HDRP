...
Shader "Skin Shaders/HDRP/HDRP_SSS7"
{
	Properties
	{
		...
		[ASEEnd]_ExtraNormalMapPower("ExtraNormalMapPower", Range( 0 , 4)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _ExtraNormalMapUVbased_ST;
			...
			sampler2D _ExtraNormalMapUVbased;
						...
						)
			{
				...
				float2 uv_ExtraNormalMapUVbased = packedInput.ase_texcoord5.xy * _ExtraNormalMapUVbased_ST.xy + _ExtraNormalMapUVbased_ST.zw;
				float3 lerpResult251 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _ExtraNormalMapUVbased, uv_ExtraNormalMapUVbased ), 1.0f ) , _ExtraNormalMapPower);
				float3 lerpResult187 = lerp( float3(0,0,1) , BlendNormal( lerpResult135 , lerpResult251 ) , _FinalNormalMapPower);
				float3 normalizeResult188 = normalize( lerpResult187 );
				float3 CarryNormals195 = normalizeResult188;
				...
				surfaceDescription.Normal = CarryNormals195;
				...
				#ifdef _MATERIAL_FEATURE_SUBSURFACE_SCATTERING
				surfaceDescription.SubsurfaceMask = lerpResult241.r;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult135 = lerp( tex2DNode111 , BlendNormal( tex2DNode111 , unpack137 ) , tex2D( _MicroDetail_WeightMapGreyscaleR, uv_MicroDetail_WeightMapGreyscaleR ).r);
				float2 uv_ExtraNormalMapUVbased = packedInput.ase_texcoord.xy * _ExtraNormalMapUVbased_ST.xy + _ExtraNormalMapUVbased_ST.zw;
				float3 lerpResult251 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _ExtraNormalMapUVbased, uv_ExtraNormalMapUVbased ), 1.0f ) , _ExtraNormalMapPower);
				float3 lerpResult187 = lerp( float3(0,0,1) , BlendNormal( lerpResult135 , lerpResult251 ) , _FinalNormalMapPower);
				float3 normalizeResult188 = normalize( lerpResult187 );
				float3 CarryNormals195 = normalizeResult188;
		...
		Pass
		{
					...
					)
			{
				...
				float3 lerpResult135 = lerp( tex2DNode111 , BlendNormal( tex2DNode111 , unpack137 ) , tex2D( _MicroDetail_WeightMapGreyscaleR, uv_MicroDetail_WeightMapGreyscaleR ).r);
				float2 uv_ExtraNormalMapUVbased = packedInput.ase_texcoord3.xy * _ExtraNormalMapUVbased_ST.xy + _ExtraNormalMapUVbased_ST.zw;
				float3 lerpResult251 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _ExtraNormalMapUVbased, uv_ExtraNormalMapUVbased ), 1.0f ) , _ExtraNormalMapPower);
				float3 lerpResult187 = lerp( float3(0,0,1) , BlendNormal( lerpResult135 , lerpResult251 ) , _FinalNormalMapPower);
				float3 normalizeResult188 = normalize( lerpResult187 );
				float3 CarryNormals195 = normalizeResult188;
		...
		Pass
		{
						...
						)
			{
				...
				float3 lerpResult135 = lerp( tex2DNode111 , BlendNormal( tex2DNode111 , unpack137 ) , tex2D( _MicroDetail_WeightMapGreyscaleR, uv_MicroDetail_WeightMapGreyscaleR ).r);
				float2 uv_ExtraNormalMapUVbased = packedInput.ase_texcoord7.xy * _ExtraNormalMapUVbased_ST.xy + _ExtraNormalMapUVbased_ST.zw;
				float3 lerpResult251 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _ExtraNormalMapUVbased, uv_ExtraNormalMapUVbased ), 1.0f ) , _ExtraNormalMapPower);
				float3 lerpResult187 = lerp( float3(0,0,1) , BlendNormal( lerpResult135 , lerpResult251 ) , _FinalNormalMapPower);
				float3 normalizeResult188 = normalize( lerpResult187 );
				float3 CarryNormals195 = normalizeResult188;
...
/*ASEBEGIN
Version=18801
1920;54;1920;975;6080.782;3742.213;7.31357;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;117;-1115.745,546.0661;Float;False;Property;_SSS_WeightAmount;SSS_WeightAmount;7;0;Create;True;0;0;0;False;0;False;0;0.664;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;51;-1471.425,-841.6143;Float;False;Property;_Albedo_Tint;Albedo_Tint;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.8113208,0.8113208,0.8113208,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;134;1214.742,606.8441;Inherit;False;1638.046;638.4865;MicroDetails;10;142;141;140;139;138;137;136;135;249;250;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;2492.061,1291.567;Float;False;Property;_ExtraNormalMapPower;ExtraNormalMapPower;35;0;Create;True;0;0;0;False;0;False;1;0;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;249;2543.977,868.4955;Float;False;Constant;_Vector1;Vector 1;35;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;250;2467.897,1040.466;Inherit;True;Property;_ExtraNormalMapUVbased;ExtraNormalMap(UV based);33;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;251;2901.528,1033.935;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;184;3380.608,631.34;Inherit;False;572.3667;435.0175;FinalNormal;3;186;187;185;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.BlendNormalsNode;247;3125.82,855.1883;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;186;3416.241,688.5233;Float;False;Constant;_Vector0;Vector 0;32;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;59;1566.091,-49.84906;Float;False;Property;_SmoothnessDeviate;SmoothnessDeviate;5;0;Create;True;0;0;0;False;0;False;0;-0.313;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;185;3484.294,944.1738;Float;False;Property;_FinalNormalMapPower;FinalNormalMapPower;34;0;Create;True;0;0;0;False;0;False;1;0.37;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;187;3754.608,709.34;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;195;5238.933,396.8583;Float;False;CarryNormals;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;2434.838,381.0009;Float;False;Property;_SSS_ToEmissive;SSS_ToEmissive;8;0;Create;True;0;0;0;False;0;False;0.1;0;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;245;5568.555,-92.26729;Inherit;True;195;CarryNormals;1;0;OBJECT;0;False;1;FLOAT3;0
...
WireConnection;260;1;245;0
WireConnection;260;7;237;0
WireConnection;260;20;241;0
ASEEND*/
//CHKSM=0263150B1DC43819482801B888A39780A93B8B53