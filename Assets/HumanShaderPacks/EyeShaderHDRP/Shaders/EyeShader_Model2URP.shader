...
Shader "RRF_HumanShaders/EyeShaders/EyeShader_Model2"
{
	Properties
	{
		...
		[ASEEnd]_ParalaxH("ParalaxH", Float) = -0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 clampResult281 = clamp( pow( saferPower282 , temp_cast_4 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float2 texCoord190 = IN.ase_texcoord7.xy * temp_cast_5 + temp_cast_6;
				...
				float saferPower368 = max( ( tex2DNode185.r * _IrisExtraColorAmountA.a * tex2DNode166.b ) , 0.0001 );
				float temp_output_368_0 = pow( saferPower368 , 2.0 );
				...
				float4 clampResult51 = clamp( ( tex2DNode166.b * clampResult354 * float4( _MainLightColor.rgb , 0.0 ) * _MainLightColor.a * lerpResult310 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float saferPower181 = max( tex2DNode166.b , 0.0001 );
				float4 lerpResult160 = lerp( clampResult51 , ( _IrisGlow * lerpResult310 * pow( saferPower181 , 3.0 ) ) , ( _IrisGlow / 10.0 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_EyeExtrasMask166 = IN.ase_texcoord2.xy;
				float4 tex2DNode166 = tex2D( _EyeExtrasMask, uv_EyeExtrasMask166 );
				float temp_output_151_0 = ( 100.0 - _PupilSize );
				float2 appendResult149 = (float2(( temp_output_151_0 / 2.0 ) , ( temp_output_151_0 / ( _PupilHeight1Width1 * 2.0 ) )));
				float4 appendResult152 = (float4(temp_output_151_0 , ( temp_output_151_0 / _PupilHeight1Width1 ) , 0.0 , 0.0));
				...
				float2 temp_cast_5 = (temp_output_260_0).xx;
				float2 temp_cast_6 = (( ( 1.0 - temp_output_260_0 ) / 2.0 )).xx;
				float2 texCoord190 = IN.ase_texcoord2.xy * temp_cast_5 + temp_cast_6;
				float mulTime320 = _TimeParameters.x * _IrisRotateSpeed;
				float cos319 = cos( mulTime320 );
				float sin319 = sin( mulTime320 );
				float2 rotator319 = mul( texCoord190 - float2( 0.5,0.5 ) , float2x2( cos319 , -sin319 , sin319 , cos319 )) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=18712
1920;54;1920;975;-98.84779;1820.243;1.406973;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-1250.485,-1404.723;Half;False;Property;_PupilSize;PupilSize;17;0;Create;True;0;0;0;False;0;False;70;44.5;0.001;89;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;226;502.8837,-243.9664;Float;False;Property;_IrisSize;IrisSize;15;0;Create;True;0;0;0;False;0;False;4.4;5.8;-20;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;277;-615.8256,-1493.539;Float;False;Property;_CustomPupilRotateSpeed;CustomPupilRotateSpeed;23;0;Create;True;0;0;0;False;0;False;0;2.14;-4;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;366;498.9249,569.83;Float;False;Property;_CausticScale;CausticScale;14;0;Create;True;0;0;0;False;0;False;1;1.68;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;367;488.3008,660.276;Float;False;Property;_CausticOffset;CausticOffset;13;0;Create;True;0;0;0;False;0;False;1;1.47;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;445.1921,-1031.941;Float;False;Property;_PupilHeight1Width1;Pupil Height>1/Width<1;18;0;Create;True;0;0;0;False;0;False;1;6.17;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;321;511.783,39.78118;Float;False;Property;_IrisRotateSpeed;IrisRotateSpeed;16;0;Create;True;0;0;0;False;0;False;0;0.46;-4;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;373;170.8089,-2044.893;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;24;0;Create;True;0;0;0;False;0;False;1.4;1.45;-4;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;265;576.427,-1721.338;Inherit;True;Property;_CustomPupil;CustomPupil;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;af50dd7b02abcc04f9f1d88772c41b91;af50dd7b02abcc04f9f1d88772c41b91;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;375;229.5917,-2127.189;Float;False;Property;_ParalaxH;ParalaxH;25;0;Create;True;0;0;0;False;0;False;-0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;166;-358.276,-237.6519;Inherit;True;Property;_EyeExtrasMask;EyeExtrasMask;2;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;d0431c3a16ed8b54c8d648bb79ca09a5;7279c4b0bec10f442a956ce8acc2046d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;170;-301.2955,-613.2215;Float;False;Property;_EyeVeinColorAmountA;EyeVeinColor-Amount(A);7;0;Create;True;0;0;0;False;0;False;0.375,0,0,0;0,0.5034485,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;305;17.00527,-702.1861;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;133;-291.8356,-797.0782;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);4;0;Create;True;0;0;0;False;0;False;1,1,1,0.878;0,0,0,0.116;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;185;1792.22,-493.9084;Inherit;True;Property;_IrisExtraDetail;IrisExtraDetail;0;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;7b7c97e104d9817418725e17f5ca2659;f6339c90c4ecdb345b2c589184d78f43;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;187;1783.495,-158.7729;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);6;0;Create;True;0;0;0;False;0;False;0.1470588,0.1024192,0.06812285,0.441;0,0.6689661,1,0.666;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;50;1213.673,264.795;Float;False;Property;_CausticPower;CausticPower;12;0;Create;True;0;0;0;False;0;False;0.3;0.784;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;213;1646.353,-1007.836;Float;False;Property;_PupilSharpness;PupilSharpness;19;0;Create;True;0;0;0;False;0;False;5;0.82;0.1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;273;1335.601,-1698.169;Float;False;Property;_InvertCustomPupil;InvertCustomPupil?;22;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;126;-293.1781,-437.5083;Float;False;Property;_IrisBaseColor;IrisBaseColor;5;0;Create;True;0;0;0;False;0;False;0.8161765,0.4123098,0.1020221,0;0,0.2857506,0.8455882,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;368;2614.204,-385.5531;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;266;2774.695,-1510.021;Float;False;Property;_UseCustomPupil;UseCustomPupil?;21;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;311;-331.7957,-30.74805;Float;False;Property;_RingColorAmountA;RingColor-Amount(A);8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.8758622,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;284;3929.797,-758.5461;Float;False;Property;_BoostEyeWhite;BoostEyeWhite;20;0;Create;True;0;0;0;False;0;False;1;1.326;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;51;4130.49,-141.9583;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LightColorNode;26;2883.552,-23.85549;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;20;509.524,-59.51176;Float;False;Property;_LensGloss;LensGloss;10;0;Create;True;0;0;0;False;0;False;0.98;0.934;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;158;502.7032,-147.7856;Float;False;Property;_IrisGlow;IrisGlow;9;0;Create;True;0;0;0;False;0;False;0;1.67;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;3194.092,-1079.333;Float;False;Property;_LensPush;LensPush;11;0;Create;True;0;0;0;False;0;False;0.64;0.74;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;384;5091.913,-425.2085;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;383;5091.913,-425.2085;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;381;5091.913,-425.2085;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;RRF_HumanShaders/EyeShaders/EyeShader_Model2;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;382;5091.913,-425.2085;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=EA14DEA9E77F557F0C4FDDBA3109A996DE5099D9